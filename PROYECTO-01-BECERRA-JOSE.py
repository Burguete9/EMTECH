...
#ORDEN Ingresos( - reembolsos)XFecha Menor a Mayor
mrxf = meses[:]
mrxf_asc = []
 
while mrxf:
    minimo = mrxf[0][3] - mrxf[0][5]
    men_may = mrxf[0]
    for i in mrxf:
        if i[3] - i[5] < minimo:
            minimo = i[3] - i[5]
            men_may = i
    mrxf_asc.append(men_may)
    mrxf.remove(men_may)

#ORDEN Ingresos(- reembolsos)XFecha Mayor a Menor
mrxf = meses[:]
mrxf_desc = []
 
while mrxf:
    maximo = mrxf[0][3] - mrxf[0][5]
    may_men = mrxf[0]
    for i in mrxf:
        if i[3] - i[5] > maximo:
            maximo = i[3] - i[5]
            may_men = i
    mrxf_desc.append(may_men)
    mrxf.remove(may_men)    
